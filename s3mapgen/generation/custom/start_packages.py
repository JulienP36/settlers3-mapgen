...
START_PACKAGE_CATALOG: tuple[StartPackageSpec, ...] = (
    ...
    StartPackageSpec(
        ...
        "start",
        "active",
        "Mini-zone rocheuse indépendante avec moyenne propre par minerai.",
        "Felsige Mineralzone",
        "Zona rocosa con minerales",
        "Independent small rocky mineral area with its own mean per mineral.",
        "Unabhängige kleine felsige Mineralzone mit eigenem Mittelwert je Mineral.",
        "Zona rocosa mineral independiente con media propia por mineral.",
    ),
    StartPackageSpec(
