...
def main():
    ...
    # The validated v2.0 engine is still calibrated for the native 768 map.
    ...
    base = f'S3_{args.archetype}_{args.mode}_{args.players}P_{args.side}x{args.side}_seed_{args.seed}_MapGenV2_0_DEV_1'
