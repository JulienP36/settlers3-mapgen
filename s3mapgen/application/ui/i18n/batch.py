...
BATCH_TEXT={
 'fr':{
  ...
  'invalid_row':'Carte {index} : {error}','unsupported_size':'taille native non prise en charge','unsupported_mode':'mode non implémenté','unsupported_archetype':'archétype non implémenté','unsupported_mode_size':'combinaison mode/taille non prise en charge',
 ...
 'en':{
  ...
  'invalid_row':'Map {index}: {error}','unsupported_size':'native size is not supported','unsupported_mode':'mode is not implemented','unsupported_archetype':'archetype is not implemented','unsupported_mode_size':'mode/size combination is not supported',
...
BATCH_TEXT['de']['unsupported_mode_size']='Modus-/Größenkombination nicht unterstützt'
BATCH_TEXT['es']['unsupported_mode_size']='combinación de modo/tamaño no compatible'
