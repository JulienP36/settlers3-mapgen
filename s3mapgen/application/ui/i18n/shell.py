...
_TEXTS_DE_ES={
 'Mode':('Modus','Modo'),'Générateur':('Generator','Generador'),'Archétype':('Archetyp','Arquetipo'),'Miroir':('Spiegel','Espejo'),'Modificateurs':('Modifikatoren','Modificadores'),'Taille':('Größe','Tamaño'),'Joueurs':('Spieler','Jugadores'),'Seed':('Seed','Seed'),'Zoom':('Zoom','Zoom'),
