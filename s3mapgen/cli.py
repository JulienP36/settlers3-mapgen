...
def main():
    ap=argparse.ArgumentParser(description='Settlers III MapGen v1.2')
    ...
    g=MapGenerator(LEGACY_PROFILE,LIBRARY,UPGRADED_PROFILE,UPGRADED_REFERENCE);res=g.generate(args.players,args.seed,mode=args.mode,archetype=args.archetype)
    ...
    base=f'S3_{args.archetype}_{args.mode}_{args.players}P_768x768_seed_{args.seed}_MapGenV1_2'
