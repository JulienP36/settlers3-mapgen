...
- [x] **Contrôle binaire déterministe des changements récents PASS** sur la géographie Upgraded auditée seed `2026082102` : checksums EDM/MAP valides ; 3721 adultes (=3557+4×41), 1151 SmallTree84 (=1067+4×21), 1715 ancres stones (=1683+4×8), stock actif 14496 (=14160+4×84), 20 ID127, les 13 états 115..127 présents, aucun footprint ID127 encore bloquant ; centres forêt à 33..35 HEX et stones à 33..34 HEX des starts. Ce contrôle isole les nouvelles passes objets et ne remplace pas une génération HEAD complète ni le test éditeur/in-game.
- [ ] **Action immédiate : contrôler le candidat v1.5 en éditeur/View Map** : starts, absence de crash, frontière traversant les clusters bonus, volume/forme des clusters, variété `115..127`, présence de quelques ID127 et constructibilité de ces tas épuisés.
