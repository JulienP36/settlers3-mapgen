...
- [ ] **Fenêtre d’aide et thèmes** : la boîte Aide repose encore sur le `messagebox` natif et ne figure donc pas dans l’inventaire des fenêtres personnalisées pilotées par la palette sémantique/DWM. Lors d’une future homogénéisation des dialogues, décider si elle reste volontairement native ou devient une vraie fenêtre d’aide thémée, sans perdre sa modalité ni son raccourci F1.
...
- [ ] Après validation de DEV_7 et avant DEV_8 : courte passe de conception GitHub **Issues + Wiki**. Définir responsabilités Issues/TODO, labels, modèles, jalons et règles de fermeture ; proposer une arborescence Wiki (prise en main, formats, vues, génération, imports/exports, data mapping, dépannage, contribution traductions/thèmes) sans dupliquer le README ni le snapshot vivant.
