...
- [ ] **Action immédiate : produire/tester une génération v1.5 fraîche** afin de valider ensemble le pipeline complet, notamment les zones de minerais Upgraded recalculées par l'algo v1.5 (~90 % du support + ratios/blobs verrouillés), les starts, l'absence de crash et la constructibilité des ID127.
