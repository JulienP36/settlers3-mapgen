...
def test_preview_position_is_clamped_inside_the_visible_screen():
    ...
    assert App._batch_clamp_preview_position(dummy,-200,-100,(400,300))==(8,8)
    assert App._batch_clamp_preview_position(dummy,900,650,(400,300))==(592,352)
...
def test_drag_uses_root_pointer_delta_and_updates_only_the_window_position():
    ...
    dummy=type('Dummy',(),{
        ...
        '_batch_clamp_preview_position':App._batch_clamp_preview_position,
    })()
    assert App._batch_preview_drag_start(dummy,type('Event',(),{'x_root':100,'y_root':100})())=='break'
    assert dummy._batch_preview_drag_origin==(100,100,50,60)
    assert App._batch_preview_drag_move(dummy,type('Event',(),{'x_root':200,'y_root':220})())=='break'
    assert win.last=='+150+180'
    assert App._batch_preview_drag_end(dummy)=='break' and dummy._batch_preview_drag_origin is None
