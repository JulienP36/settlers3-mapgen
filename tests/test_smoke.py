...
from s3mapgen.application.paths import LEGACY_PROFILE,UPGRADED_REFERENCE,LIBRARY,EDM_SCAFFOLD
...
def test_upgraded_engine_export_checksum():
    g=MapGenerator(LEGACY_PROFILE,LIBRARY,UPGRADED_REFERENCE);res=g.generate(4,2026082202,mode='upgraded',archetype='continental')
