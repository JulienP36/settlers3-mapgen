...
def test_window_title_is_fully_localized_for_v18_dev6():
    assert WINDOW_TITLES['fr'] == 'Settlers III MapGen v1.8 DEV_8_R4 — moteur de génération v1.5'
    assert WINDOW_TITLES['en'] == 'Settlers III MapGen v1.8 DEV_8_R4 — generation engine v1.5'
    assert WINDOW_TITLES['de'] == 'Settlers III MapGen v1.8 DEV_8_R4 — Generierungs-Engine v1.5'
    assert WINDOW_TITLES['es'] == 'Settlers III MapGen v1.8 DEV_8_R4 — motor de generación v1.5'
