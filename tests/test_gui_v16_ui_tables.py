...
def test_window_title_is_fully_localized_for_v18_dev4():
    assert WINDOW_TITLES['fr'] == 'Settlers III MapGen v1.8 DEV_4_R5 — moteur de génération v1.5'
    assert WINDOW_TITLES['en'] == 'Settlers III MapGen v1.8 DEV_4_R5 — generation engine v1.5'
