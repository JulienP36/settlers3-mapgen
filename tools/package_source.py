...
REQUIRED_SOURCE_PATHS = (
    ...
    "s3mapgen/application/custom/__init__.py",
    "s3mapgen/application/custom/controller.py",
    "s3mapgen/application/custom/i18n.py",
    "s3mapgen/generation/archetypes/continental.py",
    "s3mapgen/generation/custom/__init__.py",
    "s3mapgen/generation/custom/config.py",
    "s3mapgen/generation/custom/sections.py",
    "s3mapgen/generation/custom/content.py",
    "s3mapgen/generation/custom/bonus_water.py",
    "s3mapgen/generation/custom/objects.py",
    "s3mapgen/generation/custom/terrain.py",
    "s3mapgen/generation/custom/start_packages.py",
    ...
    "s3mapgen/generation/generators/upgraded/profile_defaults.py",
    ...
    "data/mineral_icons/coal.png",
    "data/mineral_icons/iron.png",
